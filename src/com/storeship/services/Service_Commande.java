...
///
    ...
    public ArrayList<Commande> getAllCommande() {
     ...
     public ArrayList<Detail_Commande> getConnectedStoresCommande() {
         ...
         String url = Statics.BASE_URL + "/gson/historique/DetailCommande/Store?store="+store.getId();
     ...
     public ArrayList<Detail_Commande> getDetailsForCommande(Commande commande) {

        String url = Statics.BASE_URL + "/gson/historiqueDetailCommandeUser?commande="+commande.getId();
...
Label etatlabel=new Label(c.getEtat());
    ...
    CommandeContainer.add(BorderLayout.EAST,combobutton);
             ...
             Button addButton = new Button("Add Reclamation");
addButton.addActionListener(e -> {
    new AddReclamation(c).show();
});
    CommandeContainer.add(BorderLayout.EAST,addButton);
